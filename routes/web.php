...
Route::middleware(['auth'])->group(function () {
    ...
    //dashbord for direct admin and user
...
Route::middleware(['middleware'=>'admin_auth'])->group(function(){
    ...
    Route::prefix('admin')->group(function(){
        ...
        Route::get('edit/profile',[AdminController::class,'editPage'])->name('admin#editPage');
    ...
    Route::prefix('order')->group(function(){
        ...
        Route::post('/status',[OrderController::class,'orderStatus'])->name('admin#orderStatus');
        Route::get('ajax/change/status',[OrderController::class,'statusChange'])->name('admin#statusChange');
        Route::get('link/Info/{orderCode}',[OrderController::class,'linkInfo'])->name('admin#linkInfo');
    });
