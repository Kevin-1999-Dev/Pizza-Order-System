        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <input type="hidden" name="" id="pizzaId" value="{{ $pizzaList->id }}">
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1"> <i class="fa-solid fa-eye"></i> {{ $pizzaList->view_count +1 }}</small>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4">{{ $pizzaList->price }}</h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button type="button" id="btnOrder" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                    </div>
